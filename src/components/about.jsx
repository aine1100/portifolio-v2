    ...
    return(
        <div className=" container mx-auto p-10 flex flex-col md:flex-row items-center justify-between md:justify-center shadow-md md:gap-[300px]">
                       ...
                       <div className="flex flex-col text-center md:text-left text-gray-600 gap-4">
                        ...
                        <p className="text-md w-[380px]  md:p-0 md:w-[450px]">I design and develop services for customers specializing creating stylish, modern websites, web services and online<br/> stores. My passion is to design digital user experiences.</p>
                        <p className="text-md w-[370px]  md:w-[450px]">I design and develop services for customers specializing creating stylish, modern websites, web services.</p>
