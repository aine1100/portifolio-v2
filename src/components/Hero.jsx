export default function Hero(){
    ...
    return(
        <div className="pb-28  px-16 md:px-12 container mx-auto flex flex-col md:flex-row justify-center items-center gap-10  md:justify-between">
           <div className="flex pt-20 flex-col items-center md:items-start  gap-10 px-20">
